 ...
 * LaQueue
 * 
 * https://www.onlinegdb.com/s/as/solve/357127?snippet_type=&readonly=&preview=#editor_11
...
int lq_send (lqd_t __msgid, const char *__msg, size_t __msg_len, unsigned int __msg_prio)
{
    ...
    //std::cout << "attempting push ";
    //std::cout << __msgid << std::endl;
    //std::cout << lqueue_table[__msgid].lq_ptr->push << std::endl;
...
ssize_t lq_receive (lqd_t __msgid, char *__msg, size_t __msg_len, unsigned int *__msg_prio)
{
    ...
    //std::cout << "displaying lq_ptr" << std::endl;
